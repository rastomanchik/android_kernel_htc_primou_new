...
static struct acdb_table_ops default_ops;
static struct acdb_table_ops * the_ops = &default_ops;
void *htc_acdb_data;
...
void acdb_table_register_ops(struct acdb_table_ops *ops)
{
	the_ops = ops;
}
...
s32 acdb_get_calibration(void)
{
	...
	int support_skip_get_acdb_table = 0;
	...
	if (support_skip_get_acdb_table == 0) {
